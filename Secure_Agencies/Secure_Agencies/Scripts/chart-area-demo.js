...
var sep = document.getElementById('<%=sep.ClientID%>');
var oct = document.getElementById('<%=oct.ClientID%>');
var nov = document.getElementById('<%=nov.ClientID%>');
var dec = document.getElementById('<%=dec.ClientID%>');
// Area Chart Example
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [jan.value, feb.value, mar.value, abr.value, ma.value, jun.value, jul.value, aug.value, sep.value, oct.value,nov.value, dec.value],
    }],
  },
  options: {
